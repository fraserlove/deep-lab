...
import regex as re
from base import Tokeniser, consecutive_pairs, replace_pair
...
class GPTTokeniser(Tokeniser):
    ...
    def __init__(self, pattern: str = None):
        ...
        self.inverse_special_tokens = {} # Inverse of special_tokens (int -> str)
    ...
    def decode(self, tokens: list[int]) -> str:
        ...
        for token in tokens:
            ...
            elif token in self.inverse_special_tokens: # Token is a special token
                byte_chunk.append(self.inverse_special_tokens[token].encode('utf-8'))
            else:
